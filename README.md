...
- **Автозаявка** — кнопка біля кожної вакансії: відкриває форму заявки Lobby X та автоматично заповнює її даними з вашого шаблону в налаштуваннях (включно з файлами CV). УВАГА! Після відправки заявки з використанням автозаявки статус вакансії автоматично не змінюється на 'є завка'. Статус у вакансії на 'є завка' потрібно змінити вручну.
- **Два бекенди даних**:
...
> {{ Скриншот 03: модалка налаштувань, вибрано «Turso (хмарна)», у полях введені URL `libsql://...turso.io` і токен }}
...
> {{ Скриншот 04: модалка налаштувань із зеленою смужкою успіху «Синхронізацію завершено: вакансій 615, оновлено 0...» }}
...
5. Після успішної відправки позначте вакансію статусом **«Є заявка»** в CRM.
...
> {{ Скриншот 05: таблиця вакансій, відфільтрована за статусом «Подав заявку» }}
...
Форма захищена reCAPTCHA, яку неможливо обійти автоматично. Програма заповнює все, окрім капчі — її проходить користувач і натискає «Відправити».

** Я скористався автозаявкою але статус у вакансії не змінився на 'є заявка' **
Після відправки заявки з використанням автозаявки статус вакансії автоматично не змінюється на 'є завка'. Статус у вакансії на 'є завка' потрібно змінити вручну. Це потрібно з причини того що система не визначає в автоматичному режимі респонс відправки форми заявки так фактично кнопку відправки заявки натискає користувач й він бачить підтверження в формі про відправку або помилку. Це дає дозволяє мати більш надійний контроль статусів відправлених заявок.  
